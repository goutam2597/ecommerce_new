...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Product Details'),actions: [Padding(
        padding: const EdgeInsets.only(right: 12),
        child: IconButton(onPressed: (){},icon:Icon(Icons.shopping_cart_outlined,size: 28,)),
      )],),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            Text('Product Description', style: textTheme.headlineSmall!.copyWith(fontWeight: FontWeight.bold)),
                            const SizedBox(height: 8),
                            Text(
                              productDetails.des ?? '',
                              style: TextStyle(
